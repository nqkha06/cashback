...
export default function Layout({ children, title = 'Backcash - Earn Cashback Everywhere' }: LayoutProps) {
    useEffect(() => {
            ...
            <nav className="fixed top-0 w-full z-50 transition-all duration-300 bg-white/80 backdrop-blur-md border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8 font-medium text-slate-600">
                        ...
                        <a href="/#brands" className="hover:text-brand-600 transition-colors">Stores</a>
                        <a href="/#categories" className="hover:text-brand-600 transition-colors">Categories</a>
